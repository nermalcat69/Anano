...
用法：
    gen-oss-manifest.py --tag v0.2.0 --assets-dir assets \
        --base-url https://d.mirror.catonthe.top/Anano --out assets/latest.json
"""
...
EXPECTED_ASSETS = [
    ("Anano-macos-arm64.dmg", "macos", "arm64", "dmg"),
    ("Anano-macos-x64.dmg", "macos", "x86_64", "dmg"),
    ("Anano-linux-x64.tar.gz", "linux", "x86_64", "tar.gz"),
    ("Anano-linux-arm64.tar.gz", "linux", "arm64", "tar.gz"),
    ("Anano-windows-x64.exe", "windows", "x86_64", "exe"),
    ("Anano-windows-x64.msi", "windows", "x86_64", "msi"),
    ("Anano-windows-arm64.exe", "windows", "arm64", "exe"),
    ("Anano-windows-arm64.msi", "windows", "arm64", "msi"),
]
...
def main() -> int:
    ...
    manifest = {
        "schema_version": 1,
        "app_id": "top.catonthe.anano",
        "version": args.tag,
        "notes_url": f"https://github.com/finch-xu/Anano/releases/tag/{args.tag}",
        "assets": entries,
    }
